...
public class NewsGetter {
    ...
    public static ArrayList<com.example.liwk.newsapp.news.NewsBean> getNews(int typeID)
    {
        ArrayList<com.example.liwk.newsapp.news.NewsBean> newsList = new ArrayList<>();
        try {
            ...
            while ((obj = objIn.readObject()) != null) {
                com.example.liwk.newsapp.news.NewsBean entry = (com.example.liwk.newsapp.news.NewsBean) obj;
    ...
    {
        ArrayList<com.example.liwk.newsapp.news.NewsBean> newsList = getNews(0);
